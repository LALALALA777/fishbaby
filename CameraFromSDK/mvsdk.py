...
# SDK动态库
_sdk = r'/home/jiang/Downloads/linuxSDK_V2.1.0.25/lib/x64/libMVSDK.so'
...
def CameraSetAeState(hCamera, bAeState):
	...
	#err_code = _sdk.CameraSetAeState(hCamera, 0)
	SetLastError(err_code)
	return err_code
...
def CameraSetExposureTime(hCamera, fExposureTime):
	...
	#err_code = _sdk.CameraSetExposureTime(hCamera, 30*1000)
	SetLastError(err_code)
	return err_code
